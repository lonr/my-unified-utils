...
如果适用于开源组件的许可条款要求 GitHub 提议提供与软件相关的源代码，GitHub 特此提出这种提议，您可以通过联系 GitHub 来执行它：[https://github.com/contact](https://github.com/contact)
...
名称 GitHub、GitHub Desktop、GitHub for Mac、GitHub for Windows、Octocat 及相关 GitHub 徽标和 / 或风格化名称都是 GitHub 的商标。 您同意，未经 GitHub 的事先书面许可，您不会以任何方式展示或使用这些商标，GitHub 的徽标和使用政策 ([https://github.com/logos](https://github.com/logos)) 明确允许的情形除外。

## [](https://docs.github.com/zh/site-policy/github-terms/github-open-source-applications-terms-and-conditions#privacy)隐私

软件可能会收集个人信息。 您可以在设置面板中控制软件收集哪些信息。 如果软件代表 GitHub 收集个人信息，GitHub 将根据 [GitHub 隐私声明](https://docs.github.com/zh/site-policy/privacy-policies/github-privacy-statement)处理这些信息。
